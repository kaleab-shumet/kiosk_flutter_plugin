...
import com.kaleabshumet.kioskmode_native.DummyNative // Added import

/** KioskFlutterPlugin */
class KioskFlutterPlugin: FlutterPlugin, MethodCallHandler {
  ...
  override fun onMethodCall(call: MethodCall, result: Result) {
    ...
    } else if (call.method == "getDummyMessage") {
      try {
